    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/" class="nav-item nav-link"><i class="fa fa-percent me-2"></i>Set Discount</a>
        ...
        <div class="col-sm-12 col-xl-6" id="blog_form">
                        <div class="bg-light rounded h-100 p-4">
                            <form action="bloge_insert" method="post" enctype="multipart/form-data">
                                @csrf
                            <h6 class="mb-4">Insert your Blog details</h6>
                            ...
                            <div class="mb-3">
                                <label for="formFile" class="form-label">Select image for your Blog</label>
                                <input class="form-control" type="file" name="img1" accept="image/*" id="formFile">
                            </div>
