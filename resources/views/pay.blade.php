...
@endif
	...
	<div class="container">
			<div class="row">
						    ...
						    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
						      <div class="card-body">
						        <div class="billing-address-form">
						        	<form method='post' action="/single_order">
										@csrf
										...
										<div class="m-5" id="card_detail">
											...
											<p><input name="" type="number" placeholder="Card number" value='' ></p>							        		
											<p class='d-flex'>
				...
				<!-- hidden product details for order_cart -->
				<input type="hidden" name='pid' value='{{$data->id}}'>
				<input type="hidden" name='p_image' value='{{$data->p_image}}'>
				<input type="hidden" name='product_name' value='{{$data->p_name}}'>
				<input type="hidden" name='dis_price' value='{{$data->dis_price}}'>
