        ...
        <div class="col-sm-12 col-xl-6" id="blog_form">
                        <div class="bg-light rounded h-100 p-4">
                            <form action="/edit_order" method="post" enctype="multipart/form-data">
                                @csrf
                                <h6 class="mb-4">Edit order Status</h6>
                                <input type="hidden" name="id" value="{{$data->id}}">
                                <div class="row mb-3">
                                    <label for="email" class="col-md-3 col-form-label">Order Status:</label>
                                <div>
                                <select class="form-control" name="status" id="category">
                                        <option value="{{$data->status}}">{{$data->status}} (Default Value)</option>
