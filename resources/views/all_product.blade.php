...
<head>
    ...
    <title>Planteria All Product Data</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="admin_index" class="nav-item nav-link"><i
                    ...
                    <a href="/all_product" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>All
                        Product</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <form class="d-none d-md-flex ms-4" style="background: transparent;">
                    <input class="form-control border-0" id="myInput" onkeyup="search()" name="search" type="search"
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr class="tr2">
                                    ...
                                    <td>{{$in->p_benefits}}</td>
                                    <td><a onclick="confirmation(event)" title="Delete Data"
                                            href="/all_product/{{$in->id}}"><i class="fa fa-trash"
                                                aria-hidden="true"></i></a>
                                        <a title="Edit Data" href="/edit/{{$in->id}}"><i class="fa fa-edit"
                                                aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                            </tbody>
