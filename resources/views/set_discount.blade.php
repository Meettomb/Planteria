...
<div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/set_discount" class="nav-item nav-link active"><i class="fa fa-percent me-2"></i>Set Discount</a>
    ...
    <div class="formbold-main-wrapper">
        <div class="formbold-form-wrapper">
            <form action="/set_discount" method="post" enctype="multipart/form-data">
            @csrf
            
            <div class="formbold-form-title">
                <h2>Set Discount Sub Category Wice</h2>
                ...
                <label for="category" class="formbold-form-label">Category</label>
                    <select class="formbold-form-input" name="pm_category" id="category" required>
                ...
                <div>
                    <label for="subcategory" class="formbold-form-label">Sub Category</label>
                        <select class="formbold-form-input" name="ps_category" id="subcategory" required>
                    </select>
                </div>
                <div>
                <label for="email" class="formbold-form-label">Discount</label>
                <input class="formbold-form-input" type="number" name="percentage" min="1" max="100" autocomplete="off" required>
                </div>

            

            <button type="submit" name="submit" class="formbold-btn">Insert Data</button>
    ...
    <div class="formbold-form-wrapper">
            <form action="/m_discount" method="post" enctype="multipart/form-data">
            @csrf
            
            <div class="formbold-form-title">
                <h2>Set discount main category wice</h2>
                ...
                <div>
                <label for="category" class="formbold-form-label">Category</label>
                    <select class="formbold-form-input" name="m_category" id="category">
                        <option selected="selected">Select item</option>
                        <option value="Plants">Plants</option>
                        <option value="Pots">Pots</option>
                        <option value="Seeds">Seeds</option>
