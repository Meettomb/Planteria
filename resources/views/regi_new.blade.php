  ...
  <div class="row d-flex flex-column">
    ...
    <div class="wrapper">
      <form action="/log_new" method="post">
        ...
        <h1>Login</h1>
        <div class="input-box">
          <input type="email" name="email" id="email" placeholder="First Name" autocomplete="off" required> 
          <i class='bx bxs-user'></i>
        </div>

        <div class="input-box">
          <input type="email" name="email" id="email" placeholder="Last Name" autocomplete="off" required> 
          <i class='bx bxs-user'></i>
        </div>
        
        <div class="input-box">
          <input type="email" name="email" id="email" placeholder="Your Address" autocomplete="off" required> 
          <i class='bx bxs-user'></i>
        </div>
        <div class="input-box">
